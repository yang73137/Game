...
function Test( settings ) {
	...
	this.assertions = [];
	this.testNumber = ++Test.defaultCount;
}
	...
	var reName = /^function (\w+)/,
		dump = {
			...
			parsers: {
				...
				// object calls it internally, the key part of an item in a map1
				key: quote,
...
QUnit.testDone(function( details ) {
	...
	// QUnit.setCount() is deprecated and will be replaced for a new
	// fixture setCount function on QUnit 2.0/2.1.
