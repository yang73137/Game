...
World_2_4 = ClassFactory.createClass(World, {
    init: function () {
        World.init.call(this);

        this.setSize(5124, 448);
        this.setBackgroundImage(Const.IMAGE_WORLD_2_4);
        this.show();

        this.scrollable = true;
        this.setTitle("World  2-4");
        
        ImageLoader.load(this, [Const.IMAGE_WORLD_3_1]);
        ScriptLoader.load(this, [Const.SCRIPT_WORLD_3_1]);
    },
    scroll: function () {
        if (!this.scrollable) {
            return;
    ...
    onChangedScene: function () {
        SoundManager.setBGM(Const.Sound.Backgrounds.CastleTheme, true, null);
    }
});